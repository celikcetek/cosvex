        ...
        <div class="row">
            <div class="col-12 mt-5 col-lg-6 md-margin-30px-bottom wow fadeInLeft">
                <div class="padding-ten-all bg-light-gray border-radius-6 lg-padding-seven-all sm-padding-30px-all h-100">
                    <span class="text-extra-dark-gray alt-font text-large font-weight-600 margin-25px-bottom d-block">Fargot Password</span>
                    <form id="contact-form" action="#" method="post">
                        <div class="row">
                            ...
                            <div class="col-12">
                                <button id="contact-us-button" name="submit" type="submit" class="btn btn-small border-radius-4 btn-dark-gray">Reset</button>
                            </div>
                        </div>
                    </form>
                </div>
