...
<section class="wow fadeIn p-0 main-slider mobile-height top-space">
    <div class="swiper-full-screen swiper-container w-100 white-move">
        <div class="swiper-wrapper">
            <div class="swiper-slide cover-background" style="background-image:url('<?php echo base_url('resources/'); ?>images/homepage-5-slider-img-3.jpg');">
                    ...
                    <div class="slider-typography text-center">
                        <div class="slider-text-middle-main">
                            <div class="slider-text-middle">
                                ...
                                <div class="btn-dual"><a href="../../item/pofo-creative-agency-corporate-and-portfolio-multipurpose-template/20645944.html" target="_blank" class="btn btn-white btn-rounded btn-medium sm-margin-two-all">Purchase Now</a></div>
                            </div>
                        </div>
                    </div>
                </div>
            </div>
            <div class="swiper-slide cover-background" style="background-image:url('<?php echo base_url('resources/'); ?>images/homepage-5-slider-img-1.jpg');">
                <div class="opacity-extra-medium bg-extra-dark-gray"></div>
                <div class="container position-relative one-fourth-screen sm-height-400px">
                    <div class="slider-typography text-center">
                        <div class="slider-text-middle-main">
            ...
            <div class="swiper-slide cover-background" style="background-image:url('<?php echo base_url('resources/'); ?>images/homepage-5-slider-img-2.jpg');">
                <div class="opacity-extra-medium bg-extra-dark-gray"></div>
                <div class="container position-relative one-fourth-screen sm-height-400px">
                    <div class="slider-typography text-center">
                        <div class="slider-text-middle-main">
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-md-4 sm-margin-30px-bottom wow fadeInUp">
                <div class="bg-white text-center h-100">
                    <a href="services-simple.html">
                        <img src="<?php echo base_url('resources/'); ?>images/latest-blog6.jpg" alt="">
                    </a>
                    <div class="padding-45px-all md-padding-15px-all">
                        ...
                        <a href="services-simple.html" class="btn btn-small btn-rounded btn-transparent-dark-gray">Explore services <i class="ti-arrow-right"></i></a>
                    </div>
                </div>
            </div>
            <div class="col-12 col-md-4 sm-margin-30px-bottom wow fadeInUp" data-wow-delay="0.2s">
                <div class="bg-white text-center h-100">
                    <a href="services-simple.html">
                        <img src="<?php echo base_url('resources/'); ?>images/latest-blog5.jpg" alt="">
                    </a>
                    <div class="padding-45px-all md-padding-15px-all">
            ...
            <div class="col-12 col-md-4 wow fadeInUp" data-wow-delay="0.4s">
                <div class="bg-white text-center h-100">
                    <a href="services-simple.html"><img src="<?php echo base_url('resources/'); ?>images/latest-blog7.jpg" alt=""></a>
                    <div class="padding-45px-all md-padding-15px-all">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 col-xl-5 col-md-6 margin-eight-bottom md-margin-40px-bottom sm-margin-30px-bottom text-center">
                ...
                <h5 class="alt-font text-white-2 font-weight-600 mb-0">We are delivering beautiful digital products for you.</h5>
            </div>
        </div>
        <div class="row">
            <div class="col-12 col-lg-3 col-md-6 md-margin-30px-bottom wow fadeInUp">
                <div class="bg-white box-shadow-light text-center padding-twelve-all feature-box-8 position-relative z-index-5 lg-padding-six-all h-100 sm-padding-15px-lr">
                    <i class="icon-desktop icon-extra-medium text-deep-pink margin-25px-bottom margin-25px-top md-margin-20px-bottom sm-margin-15px-bottom"></i>
            ...
            <div class="col-12 col-lg-3 col-md-6 md-margin-30px-bottom wow fadeInUp" data-wow-delay="0.2s">
                <div class="bg-white box-shadow-light text-center padding-twelve-all feature-box-8 position-relative z-index-5 lg-padding-six-all h-100 sm-padding-15px-lr">
                    <i class="icon-tools icon-extra-medium text-deep-pink margin-25px-bottom margin-25px-top md-margin-20px-bottom sm-margin-15px-bottom"></i>
            ...
            <div class="col-12 col-lg-3 col-md-6 wow fadeInUp sm-margin-30px-bottom" data-wow-delay="0.4s">
                <div class="bg-white box-shadow-light text-center padding-twelve-all feature-box-8 position-relative z-index-5 lg-padding-six-all h-100 sm-padding-15px-lr">
                    <i class="icon-target icon-extra-medium text-deep-pink margin-25px-bottom margin-25px-top md-margin-20px-bottom sm-margin-15px-bottom"></i>
            ...
            <div class="col-12 col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.6s">
                <div class="bg-white box-shadow-light text-center padding-twelve-all feature-box-8 position-relative z-index-5 lg-padding-six-all h-100 sm-padding-15px-lr">
                    <i class="icon-laptop icon-extra-medium text-deep-pink margin-25px-bottom margin-25px-top md-margin-20px-bottom sm-margin-15px-bottom"></i>
                ...
                <ul class="portfolio-grid work-4col hover-option4">
                        ...
                        <a href="single-project-page-01.html">
                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray">
                                    <img src="<?php echo base_url('resources/'); ?>images/portfolio-item20.jpg" alt="">
                                </div>
                                <figcaption>
                    ...
                    <li class="grid-item web branding design wow fadeInUp" data-wow-delay="0.2s">
                        <a href="single-project-page-02.html">
                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray"><img src="<?php echo base_url('resources/'); ?>images/portfolio-item23.jpg" alt=""></div>
                                <figcaption>
                                    <div class="portfolio-hover-main text-center">
                                        <div class="portfolio-hover-box vertical-align-middle">
                                            <div class="portfolio-hover-content position-relative last-paragraph-no-margin">
                    ...
                    <li class="grid-item advertising branding photography wow fadeInUp" data-wow-delay="0.4s">
                        <a href="single-project-page-03.html">
                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray"><img src="<?php echo base_url('resources/'); ?>images/portfolio-item22.jpg" alt=""></div>
                                <figcaption>
                                    <div class="portfolio-hover-main text-center">
                                        <div class="portfolio-hover-box vertical-align-middle">
                                            <div class="portfolio-hover-content position-relative last-paragraph-no-margin">
                    ...
                    <li class="grid-item web advertising design wow fadeInUp" data-wow-delay="0.6s">
                        <a href="single-project-page-04.html">
                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray"><img src="<?php echo base_url('resources/'); ?>images/portfolio-item21.jpg" alt=""></div>
                                <figcaption>
                                    <div class="portfolio-hover-main text-center">
                                        <div class="portfolio-hover-box vertical-align-middle">
                                            <div class="portfolio-hover-content position-relative last-paragraph-no-margin">
                    ...
                    <li class="grid-item web branding design wow fadeInUp">
                        <a href="single-project-page-05.html">
                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray"><img src="<?php echo base_url('resources/'); ?>images/portfolio-item24.jpg" alt=""></div>
                                <figcaption>
                                    <div class="portfolio-hover-main text-center">
                                        <div class="portfolio-hover-box vertical-align-middle">
                                            <div class="portfolio-hover-content position-relative last-paragraph-no-margin">
                    ...
                    <li class="grid-item web advertising branding design photography wow fadeInUp" data-wow-delay="0.2s">
                        <a href="single-project-page-06.html">
                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray"><img src="<?php echo base_url('resources/'); ?>images/portfolio-item25.jpg" alt=""></div>
                                <figcaption>
                                    <div class="portfolio-hover-main text-center">
                                        <div class="portfolio-hover-box vertical-align-middle">
                                            <div class="portfolio-hover-content position-relative last-paragraph-no-margin">
                    ...
                    <li class="grid-item web advertising branding design photography wow fadeInUp" data-wow-delay="0.4s">
                        <a href="single-project-page-07.html">
                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray"><img src="<?php echo base_url('resources/'); ?>images/portfolio-item26.jpg" alt=""></div>
                                <figcaption>
                                    <div class="portfolio-hover-main text-center">
                                        <div class="portfolio-hover-box vertical-align-middle">
                                            <div class="portfolio-hover-content position-relative last-paragraph-no-margin">
                    ...
                    <li class="grid-item web advertising branding design photography wow fadeInUp" data-wow-delay="0.6s">
                        <a href="single-project-page-08.html">
                            <figure>
                                <div class="portfolio-img bg-extra-dark-gray"><img src="<?php echo base_url('resources/'); ?>images/portfolio-item19.jpg" alt=""></div>
                                <figcaption>
                                    <div class="portfolio-hover-main text-center">
                                        <div class="portfolio-hover-box vertical-align-middle">
                                            <div class="portfolio-hover-content position-relative last-paragraph-no-margin">
...
<section class="wow fadeIn">
    <div class="container">
        <div class="row">
            ...
            <div class="col-12 col-lg-3 col-md-6 text-center chart-style1 wow fadeInUp md-margin-30px-bottom sm-margin-40px-bottom" data-wow-delay="0.2s">
                <div class="chart-percent"><span class="chart1 black-text" data-percent="75" data-barcolor="#00f190"><span class="percent text-extra-large text-extra-dark-gray font-weight-500"></span></span></div>
                <div class="chart-text">
                    <span class="text-uppercase text-small">Web Design</span>
                </div>
            </div>
            <div class="col-12 col-lg-3 col-md-6 text-center chart-style1 wow fadeInUp sm-margin-40px-bottom" data-wow-delay="0.4s">
            ...
            <div class="col-12 col-lg-3 col-md-6 text-center chart-style1 wow fadeInUp" data-wow-delay="0.6s">
                ...
                <div class="row m-0">
                    <div class="col-12 col-md-4 padding-5px-all grid-item feature-box-4 wow slideInDown">
                        <div class="position-relative overflow-hidden">
                            <figure class="m-0">
                                <img src="<?php echo base_url('resources/'); ?>images/case-study-01.jpg" alt="">
                    ...
                    <div class="col-12 col-md-4 padding-5px-all grid-item feature-box-4 wow slideInDown" data-wow-delay="0.2s">
                        <div class="position-relative overflow-hidden">
                            <figure class="m-0">
                                <img src="<?php echo base_url('resources/'); ?>images/case-study-02.jpg" alt="">
                                <div class="opacity-medium bg-extra-dark-gray"></div>
                                <figcaption>
                    ...
                    <div class="col-12 col-md-4 padding-5px-all grid-item feature-box-4 wow slideInDown" data-wow-delay="0.4s">
                        <div class="position-relative overflow-hidden">
                            <figure class="m-0">
                                <img src="<?php echo base_url('resources/'); ?>images/case-study-03.jpg" alt="">
                                <div class="opacity-medium bg-extra-dark-gray"></div>
                                <figcaption>
...
<section class="wow fadeIn">
    <div class="container">
        ...
        <div class="row">
            <div class="col-12 col-lg-3 col-md-6 team-block text-left team-style-1 md-margin-seven-bottom sm-margin-40px-bottom wow fadeInRight">
                <figure>
                    <div class="team-image sm-width-100">
                        <img src="<?php echo base_url('resources/'); ?>images/team13.jpg" alt="">
                        <div class="overlay-content text-center d-flex align-items-end justify-content-center">
                            <div class="icon-social-small padding-twelve-all">
                                ...
                                <a href="../../index.htm" target="_blank" class="text-white-2"><i class="fab fa-facebook-f"></i></a>
                                <a href="../../index-1.htm" target="_blank" class="text-white-2"><i class="fab fa-twitter"></i></a>
                                <a href="../../ServiceLogin.html" target="_blank" class="text-white-2"><i class="fab fa-google-plus-g"></i></a>
                                <a href="../../index-12.htm" target="_blank" class="text-white-2"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
            ...
            <div class="col-12 col-lg-3 col-md-6 team-block text-left team-style-1 md-margin-seven-bottom sm-margin-40px-bottom wow fadeInRight" data-wow-delay="0.2s">
                <figure>
                    <div class="team-image sm-width-100">
                        <img src="<?php echo base_url('resources/'); ?>images/team18.jpg" alt="">
                        <div class="overlay-content text-center d-flex align-items-end justify-content-center">
                            <div class="icon-social-small padding-twelve-all">
                                <span class="text-white-2 text-small d-inline-block m-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry dummy text.</span>
                                <div class="separator-line-horrizontal-full bg-deep-pink margin-eleven-tb"></div>
            ...
            <div class="col-12 col-lg-3 col-md-6 team-block text-left team-style-1 sm-margin-40px-bottom wow fadeInRight" data-wow-delay="0.4s">
                <figure>
                    <div class="team-image sm-width-100">
                        <img src="<?php echo base_url('resources/'); ?>images/team14.jpg" alt="">
                        <div class="overlay-content text-center d-flex align-items-end justify-content-center">
                            <div class="icon-social-small padding-twelve-all">
                                <span class="text-white-2 text-small d-inline-block m-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry dummy text.</span>
                                <div class="separator-line-horrizontal-full bg-deep-pink margin-eleven-tb"></div>
            ...
            <div class="col-12 col-lg-3 col-md-6 team-block text-left team-style-1 wow fadeInRight" data-wow-delay="0.6s">
                <figure>
                    <div class="team-image sm-width-100">
                        <img src="<?php echo base_url('resources/'); ?>images/team17.jpg" alt="">
                        <div class="overlay-content text-center d-flex align-items-end justify-content-center">
                            <div class="icon-social-small padding-twelve-all">
                                <span class="text-white-2 text-small d-inline-block m-0">Lorem Ipsum is simply dummy text of the printing and typesetting industry dummy text.</span>
                                <div class="separator-line-horrizontal-full bg-deep-pink margin-eleven-tb"></div>
                                <a href="../../index.htm" class="text-white-2" target="_blank"><i class="fab fa-facebook-f"></i></a>
                                <a href="../../index-1.htm" class="text-white-2" target="_blank"><i class="fab fa-twitter"></i></a>
                                <a href="../../ServiceLogin.html" class="text-white-2" target="_blank"><i class="fab fa-google-plus-g"></i></a>
                                <a href="../../index-12.htm" class="text-white-2" target="_blank"><i class="fab fa-instagram"></i></a>
                            </div>
                        </div>
                        <div class="team-overlay bg-extra-dark-gray opacity8"></div>
                    </div>
...
<section class="p-0 wow fadeIn bg-extra-dark-gray" id="services">
    <div class="container-fluid p-0">
        <div class="row">
            <div class="col-12 col-lg-6 position-relative md-height-550px sm-height-350px cover-background wow slideInLeft" data-wow-duration="900ms" style="background-image: url('<?php echo base_url('resources/'); ?>images/homepage-9-parallax-img4.jpg');"></div>
        ...
        <div class="row">
            <div class="col-12 col-lg-3 col-md-6 md-margin-50px-bottom sm-margin-30px-bottom last-paragraph-no-margin text-center text-md-left wow fadeInUp">
                <div class="blog-post blog-post-style1">
                    <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
                        <a href="#">
                            <img src="<?php echo base_url('resources/'); ?>images/latest-blog1.jpg" alt="">
                        </a>
                    </div>
            ...
            <div class="col-12 col-lg-3 col-md-6 md-margin-50px-bottom sm-margin-30px-bottom last-paragraph-no-margin text-center text-md-left wow fadeInUp" data-wow-delay="0.2s">
                <div class="blog-post blog-post-style1">
                    <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
                        <a href="#">
                            <img src="<?php echo base_url('resources/'); ?>images/latest-blog2.jpg" alt="">
                        </a>
                    </div>
                    <div class="post-details">
            ...
            <div class="col-12 col-lg-3 col-md-6 sm-margin-30px-bottom last-paragraph-no-margin text-center text-md-left sm-clear-both wow fadeInUp" data-wow-delay="0.4s">
                <div class="blog-post blog-post-style1">
                    <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
                        <a href="#">
                            <img src="<?php echo base_url('resources/'); ?>images/latest-blog3.jpg" alt="">
                        </a>
                    </div>
                    <div class="post-details">
            ...
            <div class="col-12 col-lg-3 col-md-6 last-paragraph-no-margin text-center text-md-left wow fadeInUp" data-wow-delay="0.6s">
                <div class="blog-post blog-post-style1">
                    <div class="blog-post-images overflow-hidden margin-25px-bottom md-margin-20px-bottom">
                        <a href="#">
                            <img src="<?php echo base_url('resources/'); ?>images/latest-blog4.jpg" alt="">
                        </a>
                    </div>
                    <div class="post-details">
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-12 position-relative text-center">
                ...
                <a href="../../item/pofo-creative-agency-corporate-and-portfolio-multipurpose-template/20645944.html" target="_blank" class="btn btn-white btn-medium align-top sm-no-margin-right btn-rounded">Purchase Theme <i class="fas fa-shopping-cart"></i></a>
            </div>
        </div>
    </div>
</section>
